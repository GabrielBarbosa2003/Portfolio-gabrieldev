        ...
        <>
            ...
            <div id='about' className='sobre'>
                ...
                <div className='texto'>
                    ...
                    <p>Contruo sites e interfaces dinamicas com a biblioteca mais crescente do mercado, React, e o back-end com Node.js, criando um script limpo e com as mais boas praticas da programaçao. </p>
                </div>
            </div>
        </>
    )
